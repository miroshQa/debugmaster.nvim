...
---@field mappings vim.api.keyset.get_keymap[]
  ...
  mappings = {
    {
      ...
      action = function()
        local UiManager = require("debugmaster.managers.UiManager")
        local win = view.new_float_anchored(UiManager.threads.buf)
        view.close_on_q(view.close_on_leave(win))
      end,
    ...
    },
    {
      ...
      action = function()
        ...
        view.close_on_q(view.close_on_leave(s.buf))
      end,
    ...
    },
    {
      ...
      action = function()
        ...
        view.close_on_q(view.close_on_leave(b.buf))
      end,
